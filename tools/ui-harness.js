...
class HeadlessUiHarness {
  ...
  reloadSystemStyleFromFileSystem() {
    ...
    const next = sessionShared.readSystemStyleState(fileProvider, {
  ...
  setActiveProcess(process) {
    ...
    this.processes.sort(sessionShared.compareProcessZOrder);
  ...
  composeDesktopSurface() {
    ...
    const stack = this.processes
      ...
      .slice()
      .sort(sessionShared.compareProcessZOrder);
